    ...
    with open(file_path, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            try:
                ...
                video_dir = "/home/user512-003/songcw/data/naochuxue/test/image_struct_jpg/"+output_directory
                ann_frame_idx = number  # the frame index we interact with
                ann_obj_id = 1  # give a unique id to each object we interact with (it can be any integers)
                output_directory = 'output_sam2_masks/boxs_struct/'+output_directory
                n = len(boxes)
